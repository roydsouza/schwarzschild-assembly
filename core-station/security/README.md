...
Formal verification layer for Aethereum-Spine. All agent-proposed actions pass through
...
|-----------------|------|----------------|
| `aethereum_spine.safety.violations_total` | counter | safety_compliance |
| `aethereum_spine.safety.verifications_total` | counter | safety_compliance |
| `aethereum_spine.safety.verification_duration_ms` | histogram | system_performance |
| `aethereum_spine.safety.constraints_total` | gauge | audit_integrity |
