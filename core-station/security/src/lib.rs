//! # Aethereum-Spine Safety Rail — Trait Contract
//!
//! Authoritative public interface for the Aethereum-Spine safety verification layer.
//! Version: 1.0.0
//!
...
pub struct ActionProposal {
    ...
    pub id: [u8; 16],
    /// Submitting agent identifier (e.g., "antigravity", "aethereum-spine").
    pub agent_id: String,
