...
Go orchestrator — the central nervous system of Sati-Central. MCP host, gRPC control
...
|-----------------|------|----------------|
| `sati_central.audit.consistency_failures_total` | counter | audit_integrity |
| `sati_central.perf.request_duration_ms` | histogram | system_performance |
| `sati_central.perf.requests_total` | counter | system_performance |
| `sati_central.cost.usd_per_day` | gauge | operational_cost |
